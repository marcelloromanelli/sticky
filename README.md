...
- `minSize`: Object with two properties width and height. If the size of the window is smaller that one of the two the element won't stick
- `horizontalCompensation`: Pixels below which we will have to compensate the window.leftScroll in order to have the element fixed only on the y-axis
